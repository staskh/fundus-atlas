...
| [BF-Net](models/bf-net.md) | Background, artery, vein, crossings | GAN-based binary-to-multi fusion, one seed | 720² → back to original, nearest neighbour | DRIVE-AV, HRF-AV or LES-AV — one archive of weights each | Yes | Yes, in the repository | GPL-3.0 | — its architecture is what the AutoMorph family runs, with other weights | 2023-02 | 2026-09-18 |
