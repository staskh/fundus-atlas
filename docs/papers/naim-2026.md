...
| Code | [https://github.com/amnaim7/Conj_Vessel_Extraction](https://github.com/amnaim7/Conj_Vessel_Extraction) |
| Dataset | IEEE DataPort — [10.21227/6583-ay07](https://doi.org/10.21227/6583-ay07) (registration) |
| Other | archived snapshot — [10.5281/zenodo.19462245](https://doi.org/10.5281/zenodo.19462245) |
...
the pupil. Naim and colleagues annotated those vessels at a chosen width (40 µm and wider)
...
- This atlas's artery/vein comparison already treats topology as a different question from overlap
  ...
  Naim 2026 is the same argument, written for tortuosity: several networks produced Dice
