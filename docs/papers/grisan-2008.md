...
gone dead; ResearchGate is a browser copy that may move. For implementers, the authors' MATLAB
reference code is at [enrigrisan/RET-Tortuosity](https://github.com/enrigrisan/RET-Tortuosity). That
