...
**Nothing has been measured yet.** The benchmark is configured and its models are built — three of
the five declared can be run — but no model has been scored on any photograph, so this page holds no
...
| Models with adapters | [vascx-artery-vein](../models/vascx-artery-vein.md) · [ocularnet](../models/ocularnet.md) · [lunet](../models/lunet.md) |
| Models declared and unrunnable | [ocularnet-nano](../models/ocularnet-nano.md), whose weights are withdrawn · [bf-net](../models/bf-net.md), whose weights cannot be pinned |
