...
| `arc` | artery | 18 |
| `sinusoid` | artery | 18 |
| `bifurcation` | artery | 12 |
| `disjoint` | artery | 16 |
| `artery-vein-pair` | artery, vein | 11 |
| `disc-spokes` | artery, vein | 15 |
...
**Generated by `python -m benchmarks --benchmark biomarker-synthetic` on:** 2026-09-20
