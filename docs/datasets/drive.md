...
| Download | **registration** — a grand-challenge account; the historical direct URL at `isi.uu.nl` no longer serves the archive |
| Citation | Staal J, Abràmoff MD, Niemeijer M, Viergever MA, van Ginneken B. *Ridge-based vessel segmentation in color images of the retina.* IEEE Transactions on Medical Imaging 2004;23(4):501–509. DOI: [10.1109/TMI.2004.825627](https://doi.org/10.1109/TMI.2004.825627) |
| Licence | Research use, subject to the terms accepted at registration. **No open licence** — DRIVE predates Creative Commons practice in this field, and redistribution is not granted |
