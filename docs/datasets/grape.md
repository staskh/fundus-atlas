...
| Microns per pixel | Not published. **Inferred, per size**: 2136² → **6.105 µm/px**; 1611² → **8.415 µm/px**, each from the median optic disc of 32 photographs, [evidence](../../results/um_resolution/grape.json). Good to roughly a tenth (§9 of the `fetch-um-resolution` skill); a camera scale, not a per-eye calibration |
