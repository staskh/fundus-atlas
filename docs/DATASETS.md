...
| Dataset&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Images | Resolution | Year | Quality | Vessels | A/V | Disc | Cup | Disease | Other labels | Licence |
| :------------------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| [DeepDRiD](datasets/deepdrid.md) +UWF | ~2,256 | mixed; **dual view per eye** | 2020 | ✅ ×3 readers, + artefact / clarity / field | — | — | — | — | ✅ DR, per image and per patient | dual-view pairing | **CC BY-SA 4.0** — share-alike |
| [FQS](datasets/fqs.md) | 2,246 | 1024×1024 (**authors' resize**) | 2025 | ✅ **continuous 0–100** + Good / Usable / Reject | — | — | — | — | — | — | paper CC BY 4.0; check the record |
