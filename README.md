...
## 4. Where the measurements are

- **[docs/BENCHMARKS.md](docs/BENCHMARKS.md)** — every benchmark, one row per model and evaluation
  unit, generated by the runs.
- **[docs/benchmarks/](docs/benchmarks/)** — one page per benchmark, saying how it was run.
- **[results/](results/)** — the score of every photograph behind every number.
- **[notebooks/](notebooks/)** — one analysis notebook per benchmark, where the judgement goes.
